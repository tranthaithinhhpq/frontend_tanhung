...
//                 if (res.EC === 0) setSections(res.DT);
//             } catch (err) {
...
//     const getImage = (sec) =>
//         sections[sec]?.[0]?.image
//             ? `${process.env.REACT_APP_BACKEND_URL}/${sections[sec][0].image.replace(/^src[\\/]+public[\\/]+/, '').replace(/\\/g, '/')}`
//             : '/default.jpg';

//     return (
//         <div className="home-intro">
//             {/* SHOT 1 */}
//             <div className="intro-block shot-1 d-flex flex-wrap align-items-center my-4">
...
//                     <img src={getImage('shot_1')} alt="Hướng dẫn khách hàng" className="img-fluid rounded shadow" />
//                 </div>
//             </div>

//             {/* SHOT 2 */}
//             <div className="intro-block shot-2 d-flex flex-wrap align-items-center my-4">
//                 <div className="image col-md-6 text-center">
//                     <img src={getImage('shot_2')} alt="Giới thiệu bệnh viện" className="img-fluid rounded shadow" />
//                 </div>
//                 <div className="text col-md-6 p-4">
//                     <h2>Giá trị cốt lõi<br />của bệnh viện</h2>
//                     <p>Bệnh viện Đa khoa Tân Hưng là nơi chăm sóc sức khỏe uy tín với đội ngũ bác sĩ giỏi, thiết bị hiện đại và dịch vụ tận tâm...</p>
